...
public interface Piece {
	...
	public enum Group {
		...
		private Group(String number, double score) {
			this.number = number;
			this.score = score;
		}
	}
	...
	public enum PieceName {
		...
		private PieceName(String classnumber, double score) {
			this.number = classnumber;
			this.score = score;
		}
	}

	public PieceName getClassName(); // 장기말 이름 왕 차 포 마 상 쫄(병) 사
	...
	public boolean move(Point move, PieceName killpiece); // 이동
