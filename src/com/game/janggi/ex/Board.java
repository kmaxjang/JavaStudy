...
public class Board {
    ...
    // 한 궁좌표
    public final Point[] castleup = { new Point(3, 0), new Point(4, 0), new Point(5, 0), new Point(3, 1),
	    new Point(4, 1), new Point(5, 1), new Point(3, 2), new Point(4, 2), new Point(5, 2), };
    // 초 궁좌표
    public final Point[] castledown = { new Point(3, 7), new Point(4, 7), new Point(5, 7), new Point(3, 8),
	    new Point(4, 8), new Point(5, 8), new Point(3, 9), new Point(4, 9), new Point(5, 9), };
    private PieceMove pm = null;

    private int[] defaultpieceset = { 1700000, 1612120, 1330300, 1141410, 1350500, 1672720, 1780800, 1203030, 1223230,
	    1243430, 1263630, 1283830, 2709090, 2617170, 2339390, 2148480, 2359590, 2677770, 2789890, 2206060, 2226260,
	    2246460, 2266660, 2286860 };
